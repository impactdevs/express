                        ...
                        <div class="blog-single-post pro-post widget-box">
                            <div class="blog-image">
                                <a href="javascript:void(0);"><img alt="Img"
                                        src="{{ URL::asset('/assets/img/blog/blog-01.jpg') }}" class="img-fluid"></a>
                            </div>
                                        ...
                                        <li>
                                            <div class="post-author">
                                                <a href="{{ url('developer-details') }}"><img
                                                        ...
                                                        alt="Post Author"><span>John Doe</span></a>
                                            </div>
                                        </li>
                            ...
                            <div class="about-author">
                                <div class="about-author-img">
                                    <div class="author-img-wrap">
                                        <a href="{{ url('developer-details') }}"><img class="img-fluid" alt="Img"
                                                src="{{ URL::asset('/assets/img/img-02.jpg') }}"></a>
                                    </div>
                                </div>
                                <div class="author-details">
                                    <a href="{{ url('developer-details') }}" class="blog-author-name">Web Designer</a>
                                ...
                                <ul class="comments-list">
                                    <li>
                                        <div class="comment">
                                            <div class="comment-author">
                                                <img class="avatar" alt="Img"
                                                    src="{{ URL::asset('/assets/img/img-02.jpg') }}">
                                            </div>
                                            <div class="comment-block">
                                                <span class="comment-by">
                                                    <span class="blog-author-name">Michelle Fairfax <span class="date">Jun
                                                            6, 2021</span></span>
                                                </span>
                                        ...
                                        <ul class="comments-list reply">
                                                    ...
                                                    <div class="comment-block">
                                                        <span class="comment-by">
                                                            <span class="blog-author-name">Gina Moore <span
                                                                    class="date">Jun 6, 2021</span></span>
                                                        </span>
                                            ...
                                            <li>
                                                <div class="comment">
                                                    <div class="comment-author">
                                                        <img class="avatar" alt="Img"
                                                            src="{{ URL::asset('/assets/img/img-04.jpg') }}">
                                                    </div>
                                                    <div class="comment-block">
                                                        <span class="comment-by">
                                    ...
                                    <li>
                                        <div class="comment">
                                            <div class="comment-author">
                                                <img class="avatar" alt="Img"
                                                    src="{{ URL::asset('/assets/img/img-05.jpg') }}">
                                            </div>
                                            <div class="comment-block">
                                                <span class="comment-by">
                                                    <span class="blog-author-name">Elsie Gilley <span class="date">Jun 6,
                                                            2021</span></span>
                                                </span>
                        ...
                        <div class=" pro-post widget-box  new-comment clearfix">
                            ...
                            <div class="pro-content">
                                <form>
                                    ...
                                    <div class="input-block">
                                        <label class="form-label">Your Email Address <span
                        ...
                        <div class="pro-content pt-0">
                            <ul class="latest-posts">
                                <li>
                                    ...
                                    <div class="post-info">
                                        <h4>
                                            <a href="{{ url('blog-details') }}">Kofejob - How to get job through
                                                online?</a>
                                        </h4>
                                        <a href="javascript:void(0);" class="posts-date"><i class="feather-calendar"></i> 2 May
                                            2021</a>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="post-info">
                                        <h4>
                                            <a href="{{ url('blog-details') }}">People who completed NAND technology got
                                                job 90% </a>
                                        </h4>
                                        <a href="javascript:void(0);" class="posts-date"><i class="feather-calendar"></i> 3 May
                                            2021</a>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="post-info">
                                        ...
                                        <a href="javascript:void(0);" class="posts-date"><i class="feather-calendar"></i> 4 May
                                            2021</a>
                                    </div>
                                </li>
                            </ul>
