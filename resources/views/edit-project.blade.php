...
@component('components.breadcrumb')
	@slot('li_1') Edit Projects @endslot                
    @slot('li_2') Home @endslot
    @slot('li_3') Edit Projects @endslot
@endcomponent	
					...
					<div class="row">		
						<div class="col-md-12">	
							<div class="text-end mb-4">	
								<a href="{{url('manage-projects')}}" class="btn btn-primary back-btn br-0"><i class="fas fa-long-arrow-alt-left"></i> Back to Project </a>
							</div>
										...
										<div class="title-detail">
											...
											<div class="upload-wrap">
												<div class="upload-document">
													<img src="{{ URL::asset('/assets/img/document.jpg')}}" alt="Image">
