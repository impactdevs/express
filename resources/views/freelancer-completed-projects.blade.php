										...
										<ul>
											...
											<li class="nav-item submenu">
												...
												<ul class="sub-menu-ul">
													...
													<li>
														<a href="{{url('freelancer-completed-projects')}}" class="active">Completed Projects</a>
													</li>
													<li>
												...
												<ul>
													...
													<li>
														<div class="project-action text-center">
															<a href="{{url('freelancer-view-project-detail')}}" class="projects-btn">View Details</a>
															<a href="{{url('freelancer-view-project-detail')}}" class="projects-btn completed-btn"><img src="{{URL::asset('/assets/img/icon/badge-sticker.svg')}}" class="me-2" alt="Img">Completed</a>
															<span>
												...
												<ul>
													...
													<li>
														<div class="project-action text-center">
															<a href="{{url('freelancer-view-project-detail')}}" class="projects-btn">View Details</a>
															<a href="{{url('freelancer-view-project-detail')}}" class="projects-btn completed-btn"><img src="{{URL::asset('/assets/img/icon/badge-sticker.svg')}}" class="me-2" alt="Img">Completed</a>
															<a href="#write-review" data-bs-toggle="modal" class="btn-write-review">Write Review</a>
														</div>
													</li>
												</ul>
											</div>
