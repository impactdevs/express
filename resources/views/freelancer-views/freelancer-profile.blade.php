								...
								<div class="profile-box">			
									<div class="provider-widget">
										<div class="pro-info-left">
											<div class="provider-img "><img src="{{ URL::asset('/assets/img/user/avatar-1.jpg')}}" class="img-fluid" alt="User"></div>
										...
										<div class="pro-info-right profile-inf">
											<a class="btn profile-edit-btn" href="{{url('freelancer-profile-settings')}}">Edit Profile</a>
										</div>
									</div>						
								</div>
									...
									<ul class="nav nav-tabs nav-tabs-solid nav-justified">
										<li class="nav-item">
											<a class="nav-link" href="#overview">
												<img src="{{ URL::asset('/assets/img/icon/tab-icon-01.png')}}" height="25" alt="User Image">
												<p class="bg-red">Overview</p>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#project">
												<img src="{{ URL::asset('/assets/img/icon/tab-icon-02.png')}}" height="25" alt="User Image">
												<p class="bg-blue">Projects</p>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#experience">
												<img src="{{ URL::asset('/assets/img/icon/tab-icon-03.png')}}" height="25" alt="User Image">
												<p class="bg-violet">Experience</p>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#education">
												<img src="{{ URL::asset('/assets/img/icon/tab-icon-04.png')}}" height="25" alt="User Image">
												<p class="bg-yellow">Education</p>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#skill">
												<img src="{{ URL::asset('/assets/img/icon/tab-icon-05.png')}}" height="25" alt="User Image">
												<p class="bg-pink">Skills</p>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#feedback">
												<img src="{{ URL::asset('/assets/img/icon/tab-icon-06.png')}}" height="25" alt="User Image">
