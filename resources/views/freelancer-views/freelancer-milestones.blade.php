							...
							<div class="col-xl-9 col-lg-8">
								...
								<nav class="user-tabs mb-4">
									<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
										...
										<li class="nav-item">
											<a class="nav-link active" href="{{url('freelancer-milestones')}}">Milestones</a>
										</li>
										<li class="nav-item">
												...
												<table class="table table-center table-hover datatable no-sort">
													...
													<tbody>
														<tr>
															...
															<td>
																<div class="action-table-data">
																	<a href="javascript:void(0);" class="btn btn-request">Request Pay</a>
																	<div>
																		<select class="select">
														...
														<tr>
															...
															<td>
																<div class="action-table-data">
																	<a href="javascript:void(0);" class="btn btn-request disabled">Request Pay</a>
																	<div>
																		<select class="select">
																			<option value="">On Hold</option>
																			<option value="">Completed</option>
