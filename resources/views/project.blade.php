...
@component('components.breadcrumb')                
    @slot('li_1') Project Grid @endslot
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
									 ...
									 <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 d-flex justify-content-sm-end">
										...
										<ul class="list-grid d-flex align-items-center">
											<li><a href="{{url('project')}}" class="favour-active"><i class="fas fa-th-large"></i></a></li>
											<li><a href="{{url('project-list')}}" ><i class="fas fa-list"></i></a></li>
										</ul>
									</div>
								</div>
						   </div>
								...
								<div class="col-xl-4 col-md-6">
									<div class="freelance-widget widget-author position-relative">
										<div class="freelance-content">
											...
											<div class="author-heading ">
												...
												<div class="freelance-info">
													...
													<div class="freelance-location"><img src="{{URL::asset('/assets/img/icon/locations.svg')}}" class="me-2" alt="img">Georgia, USA</div>
												</div>
										...
										<div class="cart-hover">
											<a href="{{url('project-details')}}" class="btn-cart" tabindex="-1">View Project</a>
										</div>
									</div>
								</div>
								<div class="col-xl-4 col-md-6">
									<div class="freelance-widget widget-author position-relative">
										<div class="freelance-content">
											...
											<div class="author-heading ">
												...
												<div class="freelance-info">
													<h3><a href="javascript:void(0);">UI/UX Developer</a></h3>
													<div class="freelance-location"><img src="{{URL::asset('/assets/img/icon/locations.svg')}}" class="me-2" alt="img">PHP Developer</div>
												</div>
												<div class="freelance-tags">
													<a href="javascript:void(0);"><span class="badge badge-pill badge-design">HTML</span></a>
													<a href="javascript:void(0);"><span class="badge badge-pill badge-design">React</span></a>
									...
									<div class="freelance-widget widget-author position-relative">
										<div class="freelance-content">
											...
											<div class="author-heading ">
												...
												<div class="freelance-info">
													<h3><a href="javascript:void(0);">Graphic Designer</a></h3>
													<div class="freelance-location"><img src="{{URL::asset('/assets/img/icon/locations.svg')}}" class="me-2" alt="img">iOS Developer</div>
												</div>
												<div class="freelance-tags">
													<a href="javascript:void(0);"><span class="badge badge-pill badge-design">HTML</span></a>
													<a href="javascript:void(0);"><span class="badge badge-pill badge-design">React</span></a>
										...
										<div class="freelance-content">
											...
											<div class="author-heading ">
												...
												<div class="freelance-info">
													...
													<div class="freelance-location"><img src="{{URL::asset('/assets/img/icon/locations.svg')}}" class="me-2" alt="img">Virginia, USA</div>
												</div>
												<div class="freelance-tags">
													<a href="javascript:void(0);"><span class="badge badge-pill badge-design">HTML</span></a>
													<a href="javascript:void(0);"><span class="badge badge-pill badge-design">React</span></a>
										...
										<div class="freelance-content">
											...
											<div class="author-heading ">
												...
												<div class="freelance-info">
													...
													<div class="freelance-location"><img src="{{URL::asset('/assets/img/icon/locations.svg')}}" class="me-2" alt="img">Delaware, USA</div>
												</div>
												<div class="freelance-tags">
													<a href="javascript:void(0);"><span class="badge badge-pill badge-design">HTML</span></a>
													<a href="javascript:void(0);"><span class="badge badge-pill badge-design">React</span></a>
										...
										<div class="freelance-content">
											...
											<div class="author-heading ">
												...
												<div class="freelance-info">
													...
													<div class="freelance-location"><img src="{{URL::asset('/assets/img/icon/locations.svg')}}" class="me-2" alt="img">Kansas, USA</div>
												</div>
												<div class="freelance-tags">
													<a href="javascript:void(0);"><span class="badge badge-pill badge-design">HTML</span></a>
													<a href="javascript:void(0);"><span class="badge badge-pill badge-design">React</span></a>
