															...
															<ul class="employee-project">
																<li>
																	<div class="project-action text-center">
																		<a href="{{url('completed-projects-view-details')}}" class="projects-btn">View Details</a>
									...
									<div class="col-xl-3 d-flex flex-wrap">
										<div class="projects-card flex-fill">
											<div class="card-body p-2">
												<div class="prj-proposal-count text-center hired">
													<h3>Hired</h3>
													<img src="{{URL::asset('/assets/img/user/user-02.jpg')}}" alt="Img" class="img-fluid">
													<p class="mb-0">Nicole Estrada</p>
												</div>
											</div>
										</div>
									</div>
