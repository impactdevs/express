...
@section('content')
            ...
            <div class="row align-items-center">
                                ...
                                <div class="input-group">
                                    <span class="drop-detail">
                                        <select class="form-control select" name="storeID">
                                            ...
                                            <option value="developer">Project</option>
                ...
                <div class="col-md-4 col-lg-5">
                    <div class="banner-img aos" data-aos="zoom-in" data-aos-duration="3000">
                        <img src="{{ URL::asset('/assets/img/banner-img.svg') }}" class="img-fluid" alt="banner">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 aos" data-aos="zoom-in" data-aos-duration="1500">
                        <div class="popular-catergories">
                            <div class="popular-catergories-img">
                                <span><img src="{{ URL::asset('/assets/img/icon/categories6.svg') }}"
                                        alt="img"></span>
                            </div>
                            <div class="popular-catergories-content">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 aos" data-aos="zoom-in" data-aos-duration="2000">
                        <div class="popular-catergories">
                            <div class="popular-catergories-img">
                                <span><img src="{{ URL::asset('/assets/img/icon/categories7.svg') }}"
                                        alt="img"></span>
                            </div>
                            <div class="popular-catergories-content">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 aos" data-aos="zoom-in" data-aos-duration="2500">
                        <div class="popular-catergories">
                            <div class="popular-catergories-img">
                                <span><img src="{{ URL::asset('/assets/img/icon/categories8.svg') }}"
                                        alt="img"></span>
                            </div>
                            <div class="popular-catergories-content">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="work-box bg1" data-aos="zoom-in" data-aos-duration="1000">
                        <div class="work-content">
                            ...
                            <a href="{{ url('project') }}" class="btn btn-primary">Browse</a>
                        </div>
                    </div>
                </div>
                <!-- /Feature Item -->
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6 aos" data-aos="zoom-in" data-aos-duration="1000">
                    <div class="feature-item freelance-count ">
                        <div class="feature-icon">
                            <img src="{{ URL::asset('/assets/img/icon/achievement-1.svg') }}" class="img-fluid"
                                alt="Img">
                        </div>
                ...
                <div class="col-xl-3 col-md-6 aos" data-aos="zoom-in" data-aos-duration="1500">
                    <div class="feature-item ">
                        <div class="feature-icon">
                            <img src="{{ URL::asset('/assets/img/icon/achievement-2.svg') }}" class="img-fluid"
                                alt="Img">
                        </div>
                        <div class="feature-content course-count">
                ...
                <div class="col-xl-3 col-md-6 aos" data-aos="zoom-in" data-aos-duration="2000">
                    <div class="feature-item comp-project ">
                        <div class="feature-icon">
                            <img src="{{ URL::asset('/assets/img/icon/achievement-3.svg') }}" class="img-fluid"
                                alt="Img">
                        </div>
                        <div class="feature-content course-count">
                ...
                <div class="col-xl-3 col-md-6 aos" data-aos="zoom-in" data-aos-duration="2500">
                    <div class="feature-item comp-project ">
                        <div class="feature-icon">
                            <img src="{{ URL::asset('/assets/img/icon/achievement-4.svg') }}" class="img-fluid"
                                alt="Img">
                        </div>
                        <div class="feature-content course-count">
                    ...
                    <div class="work-set-image">
                        <div class="work-set">
                            <div class="recent-pro-img aos" data-aos="zoom-in" data-aos-duration="1000">
                                <img src="{{ URL::asset('/assets/img/work1.jpg') }}" alt="Img" class="img-fluid ">
                            </div>
                        </div>
                        <div class="work-sets">
                            <div class="recent-pro-img">
                                <img src="{{ URL::asset('/assets/img/work2.jpg') }}" alt="Img"
                                    class="img-fluid mb-2 aos" data-aos="zoom-in" data-aos-duration="2000">
                                <img src="{{ URL::asset('/assets/img/work3.jpg') }}" alt="Img"
                                    class="img-fluid aos" data-aos="zoom-in" data-aos-duration="2500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="aos " data-aos="fade-up">
                        ...
                        <div class="demand-post-job">
                            <div class="demand-post-img">
                                <img src="{{ URL::asset('/assets/img/recent-icon-01.svg') }}" alt="Img"
                                    class="img-fluid">
                            </div>
                        ...
                        <div class="demand-post-job">
                            <div class="demand-post-img">
                                <img src="{{ URL::asset('/assets/img/recent-icon-02.svg') }}" alt="Img"
                                    class="img-fluid">
                            </div>
                            <div class="demand-content">
                        ...
                        <div class="demand-post-job">
                            <div class="demand-post-img">
                                <img src="{{ URL::asset('/assets/img/recent-icon-03.svg') }}" alt="Img"
                                    class="img-fluid">
                            </div>
                            <div class="demand-content">
                                <h6>Get Work Done</h6>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="project-item aos" data-aos="fade-up">
                        <div class="project-img">
                            <a href="{{ url('project') }}"><img
                                    src="{{ URL::asset('/assets/img/project/project-01.jpg') }}" alt="Img"
                                    class="img-fluid"></a>
                            <h6>Android Apps</h6>
                        </div>
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="project-content">
                                <h4>45</h4>
                                <h5><a href="{{ url('project') }}">Projects</a></h5>
                            </div>
                            <div class="pro-icon">
                            ...
                            <div class="project-content">
                                <h4>20</h4>
                                <h5><a href="{{ url('project') }}">Developers</a></h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                    <div class="project-item aos" data-aos="fade-up">
                        <div class="project-img">
                            <a href="{{ url('project') }}"><img
                                    src="{{ URL::asset('/assets/img/project/project-02.jpg') }}" alt="Img"
                                    class="img-fluid"></a>
                            <h6>Laravel</h6>
                        </div>
                        <div class="d-flex justify-content-between align-items-start">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                    <div class="project-item aos" data-aos="fade-up">
                        <div class="project-img">
                            <a href="{{ url('project') }}"><img
                                    src="{{ URL::asset('/assets/img/project/project-03.jpg') }}" alt="Img"
                                    class="img-fluid"></a>
                            <h6>React</h6>
                        </div>
                        <div class="d-flex justify-content-between align-items-start">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                    <div class="project-item aos" data-aos="fade-up">
                        <div class="project-img">
                            <a href="{{ url('project') }}"><img
                                    src="{{ URL::asset('/assets/img/project/project-04.jpg') }}" alt="Img"
                                    class="img-fluid"></a>
                            <h6>Angular</h6>
                        </div>
                        <div class="d-flex justify-content-between align-items-start">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                    <div class="project-item aos" data-aos="fade-up">
                        <div class="project-img">
                            <a href="{{ url('project') }}"><img
                                    src="{{ URL::asset('/assets/img/project/project-05.jpg') }}" alt="Img"
                                    class="img-fluid"></a>
                            <h6>.NET</h6>
                        </div>
                        <div class="d-flex justify-content-between align-items-start">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                    <div class="project-item aos" data-aos="fade-up">
                        <div class="project-img">
                            <a href="{{ url('project') }}"><img
                                    src="{{ URL::asset('/assets/img/project/project-06.jpg') }}" alt="Img"
                                    class="img-fluid"></a>
                            <h6>Java</h6>
                        </div>
                        <div class="d-flex justify-content-between align-items-start">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                    <div class="project-item aos" data-aos="fade-up">
                        <div class="project-img">
                            <a href="{{ url('project') }}"><img
                                    src="{{ URL::asset('/assets/img/project/project-07.jpg') }}" alt="Img"
                                    class="img-fluid"></a>
                            <h6>Python</h6>
                        </div>
                        <div class="d-flex justify-content-between align-items-start">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                    <div class="project-item aos" data-aos="fade-up">
                        <div class="project-img">
                            <a href="{{ url('project') }}"><img
                                    src="{{ URL::asset('/assets/img/project/project-08.jpg') }}" alt="Img"
                                    class="img-fluid"></a>
                            <h6>PHP</h6>
                        </div>
                        <div class="d-flex justify-content-between align-items-start">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="see-all aos" data-aos="fade-up">
                        <a href="{{ url('project') }}" class="btn all-btn">View More Projects</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="developers-slider" class="owl-carousel owl-theme developers-slider aos" data-aos="fade-up">
                <div class="freelance-widget">
                    <div class="freelance-content">
                        ...
                        <div class="freelance-info">
                            <h3><a href="{{ url('developer-details') }}">Dran Gonzalez</a></h3>
                            <div class="freelance-specific">React Developer</div>
                            <div class="freelance-location"><img src="{{ URL::asset('/assets/img/icon/locations.svg') }}"
                ...
                <div class="freelance-widget">
                    <div class="freelance-content">
                        ...
                        <div class="freelance-info">
                            <h3><a href="{{ url('developer-details') }}">Richard Wilson</a></h3>
                ...
                <div class="freelance-widget">
                    <div class="freelance-content">
                        ...
                        <div class="freelance-info">
                            <h3><a href="{{ url('developer-details') }}">Richard Wilson</a></h3>
                            <div class="freelance-specific">UI/UX Designer</div>
                            <div class="freelance-location"><img
                                    src="{{ URL::asset('/assets/img/icon/locations.svg') }}" class="me-2"
                                    alt="img">Alabama, USA</div>
                            <div class="rating">
                                <i class="fas fa-star filled"></i>
                                <i class="fas fa-star filled"></i>
                                <i class="fas fa-star filled"></i>
    ...
    <section class="section subscribe">
        <div class="bg-img">
            <img src="{{ URL::asset('/assets/img/bg/bg3.png') }}" class="bg-img3" alt="img">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-12 mx-auto ">
            ...
            <div id="testimonial-slider" class="owl-carousel owl-theme testimonial-slider aos" data-aos="fade-up">
                ...
                <div class="review-blog">
                    <div class="review-top d-flex align-items-center">
                        <div class="review-img">
                            <a href="{{ url('review') }}"><img class="img-fluid"
                                    src="{{ URL::asset('/assets/img/review/review-01.jpg') }}" alt="Post Image"></a>
                        </div>
                        ...
                        <div class="test-quote-img">
                            <img class="img-fluid" src="{{ URL::asset('/assets/img/test-quote.svg') }}" alt="quote">
                        </div>
                    </div>
                ...
                <div class="review-blog">
                    <div class="review-top d-flex align-items-center">
                        <div class="review-img">
                            <a href="{{ url('review') }}"><img class="img-fluid"
                                    src="{{ URL::asset('/assets/img/review/review-02.jpg') }}" alt="Post Image"></a>
                        </div>
                        <div class="review-info">
                ...
                <div class="review-blog">
                    <div class="review-top d-flex align-items-center">
                        <div class="review-img">
                            <a href="{{ url('review') }}"><img class="img-fluid"
                                    src="{{ URL::asset('/assets/img/review/review-03.jpg') }}" alt="Post Image"></a>
                        </div>
                        <div class="review-info">
                        ...
                        <ul class="mb-0">
                            <li>
                                <div class="company-bestimg">
                                    <img src="{{ URL::asset('/assets/img/company/theme-1.png') }}" alt="img">
                                </div>
                            </li>
                            <li>
                                <div class="company-bestimg">
                                    <img src="{{ URL::asset('/assets/img/company/theme-2.png') }}" alt="img">
                                </div>
                            </li>
                            <li>
                                <div class="company-bestimg">
                                    <img src="{{ URL::asset('/assets/img/company/theme-3.png') }}" alt="img">
                                </div>
                            </li>
                            <li>
                                <div class="company-bestimg">
                                    <img src="{{ URL::asset('/assets/img/company/theme-4.png') }}" alt="img">
                                </div>
                            </li>
                            <li>
                                <div class="company-bestimg">
                                    <img src="{{ URL::asset('/assets/img/company/theme-5.png') }}" alt="img">
                                </div>
                            </li>
                            <li>
                                <div class="company-bestimg">
                                    <img src="{{ URL::asset('/assets/img/company/theme-6.png') }}" alt="img">
                                </div>
                            </li>
                        </ul>
                    </div>
                            ...
                            <ul class="entry-meta meta-item">
                                <li>
                                    <div class="post-author">
                                        <a href="{{ url('developer-details') }}"><img
                                                src="{{ URL::asset('/assets/img/img-02.jpg') }}" alt="Post Author">
                                            <span>Aidan Funnell</span></a>
                                    </div>
                                </li>
                                <li><i class="feather-calendar me-1"></i> 4 Oct 2023</li>
                            </ul>
                            <h3 class="blog-title"><a href="{{ url('blog-details') }}">Choose a Blogging Platform</a>
                            </h3>
                            <p class="mb-0">Select a blogging platform that suits your needs. WordPress, Blogger, and
                                Medium are popular options.</p>
                            <div class="blog-read">
                                <a href="{{ url('blog-details') }}">Read More <i
                        ...
                        <div class="blog-content">
                            <ul class="entry-meta meta-item">
                                <li>
                                    <div class="post-author">
                                        <a href="{{ url('developer-details') }}"><img
                                                src="{{ URL::asset('/assets/img/img-03.jpg') }}" alt="Post Author">
                                            <span> Deborah Angel</span></a>
                                    </div>
                                </li>
                                <li><i class="feather-calendar me-1"></i> 10 Oct 2023</li>
                            </ul>
                            <h3 class="blog-title"><a href="{{ url('blog-details') }}">Pick a Domain Name</a></h3>
                        ...
                        <div class="blog-content">
                            <ul class="entry-meta meta-item">
                                <li>
                                    <div class="post-author">
                                        <a href="{{ url('developer-details') }}"><img
                                                src="{{ URL::asset('/assets/img/img-04.jpg') }}" alt="Post Author">
                                            <span>Darren Elder</span></a>
                                    </div>
                                </li>
                                <li><i class="feather-calendar me-1"></i> 3 Nov 2023</li>
                            </ul>
                            <h3 class="blog-title"><a href="{{ url('blog-details') }}">Analyze and Improve</a></h3>
                            <p class="mb-0">Use analytics tools (e.g., Google Analytics) to track your blog's
                                performance. Analyze which content performs well and adjust your strategy accordingly.</p>
                            <div class="blog-read">
                                <a href="{{ url('blog-details') }}">Read More <i
                                        class="fas fa-arrow-right ms-1"></i></a>
                            </div>
                    ...
                    <div class="register-job-blk">
                        <div class="job-content-blk aos" data-aos="fade-up">
                            ...
                            <p>Quisque pretium dolor turpis, quis blandit turpis semper ut. Nam malesuada eros nec luctus
                                laoreet.</p>
                            <a href="{{ url('register') }}" class="btn all-btn">Join Now</a>
                        </div>
                        <div class="see-all mt-0 aos opportunity" data-aos="zoom-in">
                            <img src="{{ URL::asset('/assets/img/job1.png') }}" alt="img">
                        </div>
                    </div>
                </div>
            </div>
