		...
		<div class="row">					
			...
			<div class="col-xl-3 col-md-6 aos" data-aos="zoom-in" data-aos-duration="1000">
				<div class="feature-item freelance-count ">
					<div class="feature-icon">
						<img src="{{URL::asset('/assets/img/icon/achievement-1.svg')}}" class="img-fluid" alt="Img">
					</div>
			...
			<div class="col-xl-3 col-md-6 aos" data-aos="zoom-in" data-aos-duration="1500">
				<div class="feature-item ">
					<div class="feature-icon">
						<img src="{{URL::asset('/assets/img/icon/achievement-2.svg')}}" class="img-fluid" alt="Img">
					</div>
					<div class="feature-content course-count">
			...
			<div class="col-xl-3 col-md-6 aos" data-aos="zoom-in" data-aos-duration="2000">
				<div class="feature-item comp-project ">
					<div class="feature-icon">
						<img src="{{URL::asset('/assets/img/icon/achievement-3.svg')}}" class="img-fluid" alt="Img">
					</div>
					<div class="feature-content course-count">
			...
			<div class="col-xl-3 col-md-6 aos" data-aos="zoom-in" data-aos-duration="2500">
				<div class="feature-item comp-project ">
					<div class="feature-icon">
						<img src="{{URL::asset('/assets/img/icon/achievement-4.svg')}}" class="img-fluid" alt="Img">
					</div>
					<div class="feature-content course-count">
				...
				<div class="work-set-image">
					...
					<div class="work-sets">
						<div class="recent-pro-img">
							<img src="{{URL::asset('/assets/img/work2.jpg')}}" alt="Img" class="img-fluid mb-2 aos" data-aos="zoom-in" data-aos-duration="2000">
							<img src="{{URL::asset('/assets/img/work3.jpg')}}" alt="Img" class="img-fluid aos" data-aos="zoom-in" data-aos-duration="2500">
						</div>
					</div>
				</div>
				...
				<div class="aos " data-aos="fade-up">
					...
					<div class="demand-post-job">
						<div class="demand-post-img">
							<img src="{{URL::asset('/assets/img/recent-icon-01.svg')}}" alt="Img" class="img-fluid">
						</div>
					...
					<div class="demand-post-job">
						<div class="demand-post-img">
							<img src="{{URL::asset('/assets/img/recent-icon-02.svg')}}" alt="Img" class="img-fluid">
						</div>
						<div class="demand-content">
					...
					<div class="demand-post-job">
						<div class="demand-post-img">
							<img src="{{URL::asset('/assets/img/recent-icon-03.svg')}}" alt="Img" class="img-fluid">
						</div>
						<div class="demand-content">
							<h6>Get Work Done</h6>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="project-item aos" data-aos="fade-up">
					<div class="project-img">
						<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-01.jpg')}}" alt="Img" class="img-fluid"></a>
						<h6>Android Apps</h6>
					</div>
			...
			<div class="col-lg-3 col-md-6 col-sm-6 d-flex">
				<div class="project-item aos" data-aos="fade-up">
					<div class="project-img" >
						<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-02.jpg')}}" alt="Img" class="img-fluid"></a>
						<h6>Laravel</h6>
					</div>
					<div class="d-flex justify-content-between align-items-start">
						<div class="project-content">
			...
			<div class="col-lg-3 col-md-6 col-sm-6 d-flex">
				<div class="project-item aos" data-aos="fade-up">
					<div class="project-img">
						<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-03.jpg')}}" alt="Img" class="img-fluid"></a>
						<h6>React</h6>
					</div>
					<div class="d-flex justify-content-between align-items-start">
						<div class="project-content">
			...
			<div class="col-lg-3 col-md-6 col-sm-6 d-flex">
				<div class="project-item aos" data-aos="fade-up">
					<div class="project-img">
						<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-04.jpg')}}" alt="Img" class="img-fluid"></a>
						<h6>Angular</h6>
					</div>
					<div class="d-flex justify-content-between align-items-start">
						<div class="project-content">
			...
			<div class="col-lg-3 col-md-6 col-sm-6 d-flex">
				<div class="project-item aos" data-aos="fade-up">
					<div class="project-img">
						<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-05.jpg')}}" alt="Img" class="img-fluid"></a>
						<h6>.NET</h6>
					</div>
					<div class="d-flex justify-content-between align-items-start">
						<div class="project-content">
			...
			<div class="col-lg-3 col-md-6 col-sm-6 d-flex">
				<div class="project-item aos" data-aos="fade-up">
					<div class="project-img">
						<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-06.jpg')}}" alt="Img" class="img-fluid"></a>
						<h6>Java</h6>
					</div>
					<div class="d-flex justify-content-between align-items-start">
						<div class="project-content">
			...
			<div class="col-lg-3 col-md-6 col-sm-6 d-flex">
				<div class="project-item aos" data-aos="fade-up">
					<div class="project-img">
						<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-07.jpg')}}" alt="Img" class="img-fluid"></a>
						<h6>Python</h6>
					</div>
					<div class="d-flex justify-content-between align-items-start">
						<div class="project-content">
			...
			<div class="col-lg-3 col-md-6 col-sm-6 d-flex">
				<div class="project-item aos" data-aos="fade-up">
					<div class="project-img">
						<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-08.jpg')}}" alt="Img" class="img-fluid"></a>
						<h6>PHP</h6>
					</div>
					<div class="d-flex justify-content-between align-items-start">
						<div class="project-content">
			...
			<div class="freelance-widget">
				<div class="freelance-content">
					...
					<div class="freelance-info">
						...
						<div class="freelance-location"><img src="{{URL::asset('/assets/img/icon/locations.svg')}}" class="me-2" alt="img">Illinois, USA</div>
						<div class="rating">
			...
			<div class="freelance-widget">
				<div class="freelance-content">
					...
					<div class="freelance-info">
						...
						<div class="freelance-location"><img src="{{URL::asset('/assets/img/icon/locations.svg')}}" class="me-2" alt="img">Florida, USA</div>
						<div class="rating">
							<i class="fas fa-star filled"></i>
							<i class="fas fa-star filled"></i>
							<i class="fas fa-star filled"></i>
			...
			<div class="freelance-widget">
				<div class="freelance-content">
					...
					<div class="freelance-info">
						<h3><a href="{{url('developer-details')}}">Richard Wilson</a></h3>
						<div class="freelance-specific">UI/UX Designer</div>
						<div class="freelance-location"><img src="{{URL::asset('/assets/img/icon/locations.svg')}}" class="me-2" alt="img">Alabama, USA</div>
						<div class="rating">
							<i class="fas fa-star filled"></i>
							<i class="fas fa-star filled"></i>
							<i class="fas fa-star filled"></i>
						...
						<ul class="entry-meta meta-item">
							<li>
								<div class="post-author">
									<a href="{{url('developer-details')}}"><img src="{{URL::asset('/assets/img/img-02.jpg')}}" alt="Post Author"> <span>Aidan Funnell</span></a>
								</div>
							</li>
							<li><i class="feather-calendar me-1"></i> 4 Oct 2023</li>
						</ul>
						<h3 class="blog-title"><a href="{{url('blog-details')}}">Choose a Blogging Platform</a></h3>
