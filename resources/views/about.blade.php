					...
					<div class="row justify-content-center">
						...
						<div class="col-lg-6 ">
							<div class="about-content-img aos" data-aos="zoom-in">
								<img src="{{URL::asset('/assets/img/blog/aboutus.jpg')}}" class="img-fluid" alt="img">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="about-content-img aos" data-aos="zoom-in">
								<img src="{{URL::asset('/assets/img/blog/aboutus1.jpg')}}" class="img-fluid" alt="img">
							</div>
						</div>
					</div>
				</div>
							...
							<div class="aos aos-init " data-aos="fade-up">
								...
								<div class="demand-post-job align-items-start">
									<div class="demand-post-img">
										<img src="{{URL::asset('/assets/img/icon/checks.svg')}}" alt="Img" class="img-fluid">
									</div>
						...
						<div class="col-lg-6">
							<div class="work-set-image">
								<div class="recent-pro-img aos" data-aos="zoom-in" data-aos-duration="1000">
									<img src="{{URL::asset('/assets/img/blog/abt3.png')}}" alt="Img" class="img-fluid ">
								</div>
							</div>
						</div>
					</div>
