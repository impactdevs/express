...
@section('content')		
						...
						<div class="col-lg-12 ">
							<div class="banner-blk-five justify-content-center" >
								<div class="banner-content text-center aos" data-aos="fade-up">
									...
									<form class="form"  name="store" id="store" action="{{url('project')}}">
										<div class="form-inner">
											<div class="input-group">
												<span class="drop-detail">
													<select class="form-control select" name="storeID">
														<option value="{{url('project')}}">Projects</option>
														<option value="{{url('developer')}}">Freelancers</option>
													</select>
												</span>
			...
			<div class="trusted-by-section">
				...
				<ul>
					<li>
						<img src="{{URL::asset('/assets/img/icon/trusted1.svg')}}" alt="Img">
					</li>
					<li>
						<img src="{{URL::asset('/assets/img/icon/trusted2.svg')}}" alt="Img">
					</li>
					<li>
						<img src="{{URL::asset('/assets/img/icon/trusted3.svg')}}" alt="Img">
					</li>
					<li>
						<img src="{{URL::asset('/assets/img/icon/trusted4.svg')}}" alt="Img">
					</li>
					<li>
						<img src="{{URL::asset('/assets/img/icon/trusted5.svg')}}" alt="Img">
					</li>
				</ul>
			</div>
					...
					<div class="category-slider-section">
						<div id="category-slider" class="owl-carousel owl-theme blog-trick-five blog-slider aos" data-aos="fade-up">
							<div class="project-by-category-widget">
								<a href="{{url('project')}}" class="category-widget-img">
									<img src="{{URL::asset('/assets/img/slider/category-img-1.jpg')}}" class="img-fluid" alt="slider-image">
								</a>
							...
							<div class="project-by-category-widget">
								<a href="{{url('project')}}" class="category-widget-img">
									<img src="{{URL::asset('/assets/img/slider/category-img-2.jpg')}}" class="img-fluid" alt="slider-image">
								</a>
								<div class="category-widget-content">
									<h5>SEO</h5>
							...
							<div class="project-by-category-widget">
								<a href="{{url('project')}}" class="category-widget-img">
									<img src="{{URL::asset('/assets/img/slider/category-img-3.jpg')}}" class="img-fluid" alt="slider-image">
								</a>
								<div class="category-widget-content">
									<h5>Illustration</h5>
							...
							<div class="project-by-category-widget">
								<a href="{{url('project')}}" class="category-widget-img">
									<img src="{{URL::asset('/assets/img/slider/category-img-4.jpg')}}" class="img-fluid" alt="slider-image">
								</a>
								<div class="category-widget-content">
									<h5>Translation</h5>
							...
							<div class="project-by-category-widget">
								<a href="{{url('project')}}" class="category-widget-img">
									<img src="{{URL::asset('/assets/img/slider/category-img-5.jpg')}}" class="img-fluid" alt="slider-image">
								</a>
								<div class="category-widget-content">
									<h5>Data Entry</h5>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="home-five-section-btn">
								<a href="{{url('project')}}" class="btn btn-primary">View all Categories</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 col-sm-6 d-flex">
							<div class="project-item project-popular-item aos" data-aos="fade-up">
								<div class="project-img">
									<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-35.jpg')}}" alt="Img" class="img-fluid"></a>
								</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-6 d-flex">
							<div class="project-item project-popular-item aos" data-aos="fade-up">
								<div class="project-img">
									<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-36.jpg')}}" alt="Img" class="img-fluid"></a>
								</div>
								<div class="feature-content">
						...
						<div class="col-lg-4 col-md-6 col-sm-6 d-flex">
							<div class="project-item project-popular-item aos" data-aos="fade-up">
								<div class="project-img">
									<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-37.png')}}" alt="Img" class="img-fluid"></a>
								</div>
								<div class="feature-content">
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="work-set-image">
								<img src="{{URL::asset('/assets/img/work4.png')}}" alt="Img" class="img-fluid ">
							</div>
							...
							<div class="aos " data-aos="fade-up">
								...
								<div class="demand-post-job">
									<div class="demand-post-img">
										<img src="{{URL::asset('/assets/img/icon/recent-icon-04.svg')}}" alt="Img" class="img-fluid">
									</div>
								...
								<div class="demand-post-job">
									<div class="demand-post-img">
										<img src="{{URL::asset('/assets/img/icon/recent-icon-05.svg')}}" alt="Img" class="img-fluid">
									</div>
									<div class="demand-content">
								...
								<div class="demand-post-job">
									<div class="demand-post-img">
										<img src="{{URL::asset('/assets/img/icon/recent-icon-06.svg')}}" alt="Img" class="img-fluid">
									</div>
									<div class="demand-content">
										<h6>Get Work Done</h6>
							...
							<div class="col-md-6 d-flex align-items-center">
								<div class="join-market-world aos" data-aos="fade-up">
									...
									<div class="market-place-btn bidding-btn">
										...
										<a href="{{url('project')}}" class="btn btn-primary project-post">Start Bidding</a>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="join-platform-img aos" data-aos="fade-up">
									<img src="{{URL::asset('/assets/img/platform-img1.png')}}" alt="Img" class="img-fluid">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="hired-developers aos" data-aos="fade-up">
								<div class="hired-developers-img">
									<a href="{{url('developer-details')}}"><img src="{{URL::asset('/assets/img/developer/developer-13.jpg')}}" class="img-fluid" alt="Img"></a>
								</div>
								<div class="hired-developers-img-content d-flex justify-content-between align-items-start">
									<div>
										...
										<h4><a href="{{url('developer-details')}}">Steven Picard</a></h4>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="hired-developers aos" data-aos="fade-up">
								<div class="hired-developers-img">
									<a href="{{url('developer-details')}}"><img src="{{URL::asset('/assets/img/developer/developer-14.jpg')}}" class="img-fluid" alt="Img"></a>
								</div>
								<div class="hired-developers-img-content d-flex justify-content-between align-items-start">
									<div>
										<a data-toggle="modal" href="#rating" class="favourite color-active"><i class="feather-heart"></i></a>
										<h4><a href="{{url('developer-details')}}">Aroon Merkel</a></h4>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="hired-developers aos" data-aos="fade-up">
								<div class="hired-developers-img">
									<a href="{{url('developer-details')}}"><img src="{{URL::asset('/assets/img/developer/developer-15.jpg')}}" class="img-fluid" alt="Img"></a>
								</div>
								<div class="hired-developers-img-content d-flex justify-content-between align-items-start">
									<div>
										<a data-toggle="modal" href="#rating" class="favourite color-active"><i class="feather-heart"></i></a>
										<h4><a href="{{url('developer-details')}}">Durso Raeen</a></h4>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="hired-developers aos" data-aos="fade-up">
								<div class="hired-developers-img">
									<a href="{{url('developer-details')}}"><img src="{{URL::asset('/assets/img/developer/developer-16.jpg')}}" class="img-fluid" alt="Img"></a>
								</div>
								<div class="hired-developers-img-content d-flex justify-content-between align-items-start">
									<div>
										<a data-toggle="modal" href="#rating" class="favourite color-active"><i class="feather-heart"></i></a>
										<h4><a href="{{url('developer-details')}}">Andrew Jene</a></h4>
											...
											<div class="col-md-3">
												<div class="img-reviews">
													<div class="review-quote">
														<img src="{{URL::asset('/assets/img/quote-02.svg')}}" alt="Img">
													</div>
													<img src="{{URL::asset('/assets/img/user/avatar-4.jpg')}}" alt="Img">
												</div>
											</div>
											<div class="col-md-9">
										...
										<div class="row">
											<div class="col-md-3">
												<div class="img-reviews">
													...
													<img src="{{URL::asset('/assets/img/user/avatar-2.jpg')}}" alt="Img">
												</div>
											</div>
											<div class="col-md-9">
												<div class="testimonial-two-head ">
										...
										<div class="row">
											<div class="col-md-3">
												<div class="img-reviews">
													...
													<img src="{{URL::asset('/assets/img/user/avatar-3.jpg')}}" alt="Img">
												</div>
											</div>
											<div class="col-md-9">
												<div class="testimonial-two-head ">
									...
									<div class="testimonial-all d-flex justify-content-center">
										<div class="row">
											<div class="col-md-3">
												<div class="img-reviews">
													<div class="review-quote">
														<img src="{{URL::asset('/assets/img/quote-01.svg')}}" alt="Img">
													</div>
													<img src="{{URL::asset('/assets/img/user/avatar-4.jpg')}}" alt="Img">
												</div>
											</div>
										...
										<div class="row">
											<div class="col-md-3">
												<div class="img-reviews">
													...
													<img src="{{URL::asset('/assets/img/user/avatar-5.jpg')}}" alt="Img">
												</div>
											</div>
											<div class="col-md-9">
												<div class="testimonial-two-head ">
			...
			<section class="section job-registers">
				...
				<div class="container position-relative job-register">		
					<div class="float-img">
						<img src="{{URL::asset('/assets/img/opportunity.png')}}" alt="img">
					</div>		
					<div class="row">
						<div class="col-12">
