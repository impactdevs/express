									...
									<div class="provider-widget">
										<div class="pro-info-left">
											<div class="provider-img">
												<img src="{{ URL::asset('/assets/img/img-04.jpg')}}" alt="User">
											...
											<div class="profile-info profile-edit-form">
												...
												<div class="pro-text3">
													...
													<ul class="profile-preword">
														<li><img src="{{ URL::asset('/assets/img/flags/pl.png')}}" alt="" height="16"> Poland</li>
														<li><div class="rating">							
									...
									<ul class="nav nav-tabs nav-tabs-solid nav-justified">
										<li class="nav-item">
											<a class="nav-link active" href="#overview" data-bs-toggle="tab">
												<img class="img-fluid" alt="User Image" src="{{ URL::asset('/assets/img/icon/tab-icon-01.png')}}">
												<p class="bg-red">Overview</p>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#bids" data-bs-toggle="tab">
												<img class="img-fluid" alt="User Image" src="{{ URL::asset('/assets/img/icon/tab-icon-02.png')}}">
												<p class="bg-blue">Bids</p>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#jobs" data-bs-toggle="tab">
												<img class="img-fluid" alt="User Image" src="{{ URL::asset('/assets/img/icon/tab-icon-05.png')}}">
												<p class="bg-pink">Jobs</p>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#portfolio" data-bs-toggle="tab">
												<img class="img-fluid" alt="User Image" src="{{ URL::asset('/assets/img/icon/tab-icon-07.png')}}">
												<p class="bg-yellow">Portfolio</p>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#feedbacks" data-bs-toggle="tab">
												<img alt="User Image" height="28" src="{{ URL::asset('/assets/img/icon/tab-icon-06.png')}}">
												<p class="bg-green">Feedbacks</p>
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="#payments" data-bs-toggle="tab">
												<img class="img-fluid" alt="User Image" src="{{ URL::asset('/assets/img/icon/tab-icon-08.png')}}">
											...
											<div class="col-md-6 col-lg-12 col-xl-6">
												<div class="freelance-widget widget-author">
													...
													<div class="cart-hover">
														<a href="{{url('project-details')}}" class="btn-cart" tabindex="-1">Buy Now</a>
													</div>
					                            </div>
											</div>
											<div class="col-md-6 col-lg-12 col-xl-6">
										...
										<div class="row">
												...
												<div class="project-widget">
													<div class="pro-image">
														<a href="{{url('project-details')}}">
															<img class="img-fluid" alt="User Image" src="{{ URL::asset('/assets/img/project.jpg')}}">
														</a>
													</div>
													<div class="pro-detail">
														<h3 class="pro-name">
															<a href="{{url('project-details')}}">Project name</a> 
														</h3>
											...
											<div class="col-sm-6 col-lg-4 col-xl-3">
												<div class="project-widget">
													<div class="pro-image">
														<a href="{{url('project-details')}}">
															<img class="img-fluid" alt="User Image" src="{{ URL::asset('/assets/img/project-7.jpg')}}">
														</a>
													</div>
													<div class="pro-detail">
														<h3 class="pro-name">
							...
							<div role="tabpanel" id="feedbacks" class="tab-pane fade">
								<div class="pro-post project-widget widget-box">
									...
									<div class="about-author">
										<div class="about-author-img">
											<div class="author-img-wrap">
												<a href="{{url('review')}}"><img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/img-01.png')}}"></a>
											</div>
										</div>
										<div class="author-details">
											<a href="{{url('review')}}" class="blog-author-name">Logo Designer</a>
									...
									<div class="about-author">
										<div class="about-author-img">
											<div class="author-img-wrap">
												<a href="{{url('review')}}"><img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/img-02.jpg')}}"></a>
											</div>
										</div>
										<div class="author-details">
											<a href="{{url('review')}}" class="blog-author-name">Logo Designer</a>
									...
									<div class="about-author">
										<div class="about-author-img">
											<div class="author-img-wrap">
												<a href="{{url('review')}}"><img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/img-03.jpg')}}"></a>
											</div>
										</div>
										<div class="author-details">
							...
							<div role="tabpanel" id="payments" class="tab-pane fade">
								<div class="pro-post project-widget">
									...
									<div class="row">
										<div class="col-12 col-sm-4">
											<div class="pro-post payment-detail">
												<img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/icon/pay-icon-01.png')}}">
										...
										<div class="col-12 col-sm-4">
											<div class="pro-post payment-detail">
												<img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/icon/pay-icon-02.png')}}">
										...
										<div class="col-12 col-sm-4">
											<div class="pro-post payment-detail">
												<img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/icon/pay-icon-03.png')}}">
									...
									<div class="transaction">
										<img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/icon/redeem-icon.png')}}">
							...
							<div class="pro-post">	
								<div class="follow-widget">
									<div class="text-end custom-edit-btn">												
										<a href="{{url('freelancer-profile-settings')}}" class="sub-title"><i class="fa fa-pencil-alt me-1"></i></a>
									</div>
