										...
										<ul>
											...
											<li class="nav-item submenu">
												...
												<ul class="sub-menu-ul">
													...
													<li>
														<a href="{{url('freelancer-cancelled-projects')}}" class="active">Cancelled Projects</a>
													</li>
												</ul>
											</li>
											<li class="nav-item submenu">
												...
												<ul>
													...
													<li>
														<div class="project-action text-center">
															<a href="{{url('freelancer-view-project-detail')}}" class="projects-btn">Remove Project</a>
														</div>
													</li>
												</ul>
											</div>
