                ...
                <div class="col-lg-8 col-md-12">
                    <div class="company-detail-block pt-0">
                        <div class="company-detail">
                            <div class="company-detail-image">
                                <img src="{{ URL::asset('/assets/img/img-04.jpg') }}" class="img-fluid" alt="logo">
                            </div>
                    ...
                    <div class="company-detail-block company-description">
                        ...
                        <p class="mb-0">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                            ...
                            architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam consequuntur magni dolores eos qui
                    ...
                    <div class="company-detail-block company-description">
                        ...
                        <div class="experience-set">
                            <div class="experience-set-img">
                                <img src="{{ URL::asset('/assets/img/icon/expereience.png') }}" alt="img">
                            </div>
                    ...
                    <div class="company-detail-block company-description">
                        ...
                        <div class="experience-set">
                            <div class="experience-set-img">
                                <img src="{{ URL::asset('/assets/img/icon/report.png') }}" alt="img">
                            </div>
                            <div class="experience-set-content">
                    ...
                    <div class="company-detail-block pb-0">
                        ...
                        <div class="project-proposals-block ">
                            <div class="project-proposals-img">
                                <img src="{{ URL::asset('/assets/img/user/avatar-1.jpg') }}" class="img-fluid"
                                    alt="user">
                            </div>
                            <div class="project-proposals-description">
                                ...
                                <p class="mb-0">I've been buying and selling on kofejob Marketplace for the past two
                                    years, and it's been a game-changer for me. The platform is user-friendly, and I've had
                                    great success selling my handmade crafts. Plus, the customer support team is always
                                    there to help if I have any questions or issues.</p>
                            </div>
                        </div>
                        <div class="project-proposals-block ">
                            <div class="project-proposals-img">
                                <img src="{{ URL::asset('/assets/img/user/avatar-2.jpg') }}" class="img-fluid"
                                    alt="user">
                            </div>
                            <div class="project-proposals-description">
                                <div class="proposals-user-detail">
                        ...
                        <div class="project-proposals-block ">
                            <div class="project-proposals-img">
                                <img src="{{ URL::asset('/assets/img/user/avatar-3.jpg') }}" class="img-fluid"
                                    alt="user">
                            </div>
                            <div class="project-proposals-description">
                                <div class="proposals-user-detail">
                        ...
                        <div class="project-proposals-block ">
                            <div class="project-proposals-img">
                                <img src="{{ URL::asset('/assets/img/user/avatar-4.jpg') }}" class="img-fluid"
                                    alt="user">
                            </div>
                            <div class="project-proposals-description">
                                <div class="proposals-user-detail">
                        ...
                        <div class="project-proposals-block ">
                            <div class="project-proposals-img">
                                <img src="{{ URL::asset('/assets/img/user/avatar-5.jpg') }}" class="img-fluid"
                                    alt="user">
                            </div>
                            <div class="project-proposals-description">
                                <div class="proposals-user-detail">
                ...
                <div class="col-lg-4 col-md-12 sidebar-right theiaStickySidebar project-client-view">
                    ...
                    <div class="card budget-widget">
                        ...
                        <div class="tags">
                            ...
                            <a href="javascript:void(0);"><span class="badge badge-pill badge-design">Software
                                    Design</span></a>
                            <a href="javascript:void(0);"><span class="badge badge-pill badge-design">HTML5</span></a>
                            <a href="javascript:void(0);"><span class="badge badge-pill badge-design">Design
                                    Writing</span></a>
                            <a href="javascript:void(0);"><span
                                    class="badge badge-pill badge-design">Whiteboard</span></a>
