						...
						<div class="row align-items-center">
							...
							<div class="col-md-4 col-lg-5">
								<div class="banner-two-img aos" data-aos="fade-up">
									<img src="{{URL::asset('/assets/img/home-two-banner-bg-01.png')}}" class="img-fluid trusted-user-img aos" data-aos="zoom-in" alt="banner"  data-aos-duration="3000">
									<img src="{{URL::asset('/assets/img/home-two-banner-bg-02.png')}}" class="img-fluid best-marketing-img aos" data-aos="zoom-in" alt="banner"  data-aos-duration="3000">
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-xl-3 col-md-6">
								<div class="aos" data-aos="fade-up">
									<a href="{{url('project')}}" class="update-project-blk move-box ">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="plat-form-img aos" data-aos="fade-up">
									<img src="{{URL::asset('/assets/img/plat-form.png')}}" alt="Img" class="img-fluid">
								</div>
							</div>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="project-item feature-project-item aos" data-aos="fade-up">
									<div class="project-img">
										<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-19.jpg')}}" alt="Img" class="img-fluid"></a>
									</div>
									<div class="feature-content">
										...
										<h4><a href="{{url('project')}}">3D Renders and Amazon Product</a></h4>
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="project-item feature-project-item aos" data-aos="fade-up">
									<div class="project-img">
										<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-20.jpg')}}" alt="Img" class="img-fluid"></a>
									</div>
									<div class="feature-content">
										<div class="feature-time-blk">
										...
										<h4><a href="{{url('project')}}">Web Development for a Shopify Store</a></h4>
										<ul class="feature-project-list nav">
										...
										<div class="feature-foot">
											<div class="logo-company">
												<a href="{{url('project')}}">
													<img src="{{URL::asset('/assets/img/icon/logo-icon-02.svg')}}" class="me-1" alt="icon">
													<span>PARK INC</span>
												</a>
											</div>
											<a href="{{url('project-details')}}" class="bid-now">Buy Now <i class="feather-arrow-right ms-1"></i></a>
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="project-item feature-project-item aos" data-aos="fade-up">
									<div class="project-img">
										<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-21.jpg')}}" alt="Img" class="img-fluid"></a>
									</div>
									<div class="feature-content">
										<div class="feature-time-blk">
											<a href="javascript:void(0);" class="btn btn-primary green-active">Full Time</a>
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="project-item feature-project-item aos" data-aos="fade-up">
									<div class="project-img">
										<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-22.jpg')}}" alt="Img" class="img-fluid"></a>
									</div>
									<div class="feature-content">
										<div class="feature-time-blk">
											<a href="javascript:void(0);" class="btn btn-primary green-active">Full Time</a>
										...
										<div class="feature-foot">
											<div class="logo-company">
											<a href="{{url('project')}}">
												<img src="{{URL::asset('/assets/img/icon/logo-icon-03.svg')}}" class="me-1" alt="icon">
												<span>AMAZE TECH</span>
											</a>
											</div>
											<a href="{{url('project-details')}}" class="bid-now">Buy Now <i class="feather-arrow-right ms-1"></i></a>
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="project-item feature-project-item aos" data-aos="fade-up">
									<div class="project-img">
										<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-23.jpg')}}" alt="Img" class="img-fluid"></a>
									</div>
									<div class="feature-content">
										<div class="feature-time-blk">
											<a href="javascript:void(0);" class="btn btn-primary sky-active">Part Time</a>
										...
										<h4><a href="{{url('project')}}">Landing Page Redesign / Sales Page</a> </h4>
										<ul class="feature-project-list nav">
											<li><i class="feather-user me-1"></i>Web Development</li>
											<li><i class="feather-map-pin me-1"></i>Kentucky, USA</li>
										</ul>
							...
							<div class="col-lg-4 col-md-6 d-flex">
								<div class="project-item feature-project-item aos" data-aos="fade-up">
									<div class="project-img">
										<a href="{{url('project')}}"><img src="{{URL::asset('/assets/img/project/project-24.jpg')}}" alt="Img" class="img-fluid"></a>
									</div>
									<div class="feature-content">
										<div class="feature-time-blk">
											<a href="javascript:void(0);" class="btn btn-primary green-active">Full Time</a>
										...
										<div class="feature-foot">
											<div class="logo-company">
												<a href="{{url('project')}}">
													<img src="{{URL::asset('/assets/img/icon/logo-icon-04.svg')}}" class="me-1" alt="icon">
													<span>AMAZE TECH</span>
												</a>
											</div>
											<a href="{{url('project-details')}}" class="bid-now">Buy Now <i class="feather-arrow-right ms-1"></i></a>
						...
						<div class="row">
								...
								<div class="feature-develop-blk aos" data-aos="fade-up">
									<div class="developer-sub-blk">
										<div class="img-developer">
											<a href="{{url('developer-details')}}"><img src="{{URL::asset('/assets/img/user/avatar-21.jpg')}}" class="me-2" alt="Img"></a>
										</div>
										<div class="developer-content">
											<h4><a href="{{url('developer-details')}}">Dran Gonzalez</a></h4>
											<p>React Developer</p>
											<div class="rating">
							...
							<div class="col-xl-3 col-md-6">
								<div class="feature-develop-blk aos" data-aos="fade-up">
									<div class="developer-sub-blk">
										<div class="img-developer">
											<a href="{{url('developer-details')}}"><img src="{{URL::asset('/assets/img/user/avatar-22.jpg')}}" class="me-2" alt="Img"></a>
										</div>
										<div class="developer-content">
											<h4><a href="{{url('developer-details')}}">Nicole Black</a></h4>
							...
							<div class="col-xl-3 col-md-6">
								<div class="feature-develop-blk aos" data-aos="fade-up">
									<div class="developer-sub-blk">
										<div class="img-developer">
											<a href="{{url('developer-details')}}"><img src="{{URL::asset('/assets/img/user/avatar-23.jpg')}}" class="me-2" alt="Img"></a>
										</div>
										<div class="developer-content">
											<h4><a href="{{url('developer-details')}}">Megan Torres</a></h4>
											<p>Java Developer</p>
											<div class="rating">
												<i class="fas fa-star filled"></i>
												<i class="fas fa-star filled"></i>
							...
							<div class="col-xl-3 col-md-6">
								<div class="feature-develop-blk aos" data-aos="fade-up">
									<div class="developer-sub-blk">
										<div class="img-developer">
											<a href="{{url('developer-details')}}"><img src="{{URL::asset('/assets/img/user/avatar-24.jpg')}}" class="me-2" alt="Img"></a>
										</div>
										<div class="developer-content">
											<h4><a href="{{url('developer-details')}}">Shan Morris</a></h4>
											<p>React Developer</p>
											<div class="rating">
												<i class="fas fa-star filled"></i>
												<i class="fas fa-star filled"></i>
							...
							<div class="col-xl-3 col-md-6">
								<div class="feature-develop-blk aos" data-aos="fade-up">
									<div class="developer-sub-blk">
										<div class="img-developer">
											<a href="{{url('developer-details')}}"><img src="{{URL::asset('/assets/img/user/avatar-25.jpg')}}" class="me-2" alt="Img"></a>
										</div>
										<div class="developer-content">
											<h4><a href="{{url('developer-details')}}">Dran Gonzalez</a></h4>
											<p>React Developer</p>
							...
							<div class="col-xl-3 col-md-6">
								<div class="feature-develop-blk aos" data-aos="fade-up">
									<div class="developer-sub-blk">
										<div class="img-developer">
											<a href="{{url('developer-details')}}"><img src="{{URL::asset('/assets/img/user/avatar-26.jpg')}}" class="me-2" alt="Img"></a>
										</div>
										<div class="developer-content">
											<h4><a href="{{url('developer-details')}}">Nicole Black</a></h4>
											<p>Angular Developer</p>
							...
							<div class="col-xl-3 col-md-6">
								<div class="feature-develop-blk aos" data-aos="fade-up">
									<div class="developer-sub-blk">
										<div class="img-developer">
											<a href="{{url('developer-details')}}"><img src="{{URL::asset('/assets/img/user/avatar-27.jpg')}}" class="me-2" alt="Img"></a>
										</div>
										<div class="developer-content">
											<h4><a href="{{url('developer-details')}}">Megan Torres</a> </h4>
											<p>Java Developer</p>
							...
							<div class="col-xl-3 col-md-6">
								<div class="feature-develop-blk aos" data-aos="fade-up">
									<div class="developer-sub-blk">
										<div class="img-developer">
											<a href="{{url('developer-details')}}"><img src="{{URL::asset('/assets/img/user/avatar-28.jpg')}}" class="me-2" alt="Img"></a>
										</div>
										<div class="developer-content">
											<h4><a href="{{url('developer-details')}}">Shan Morris</a></h4>
											<p>React Developer</p>
							...
							<div class="col-xl-12">
								<div class="more-project text-center aos" data-aos="fade-up">
									<a href="{{url('developer-details')}}" class="btn btn-primary">View More Freelancers</a>
								</div>
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-xl-3 col-md-6">
								<div class="great-blk aos" data-aos="fade-up">
									<div class="great-icon">
										<img src="{{URL::asset('/assets/img/icon/great-icon-01.svg')}}"  alt="Img">
									</div>
							...
							<div class="col-xl-3 col-md-6">
								<div class="great-blk aos" data-aos="fade-up">
									<div class="great-icon">
										<img src="{{URL::asset('/assets/img/icon/great-icon-02.svg')}}"  alt="Img">
									</div>
									<div class="great-content">
										<h4>Fast bids</h4>
							...
							<div class="col-xl-3 col-md-6">
								<div class="great-blk aos" data-aos="fade-up">
									<div class="great-icon">
										<img src="{{URL::asset('/assets/img/icon/great-icon-03.svg')}}"  alt="Img">
									</div>
									<div class="great-content">
										<h4>Quality work</h4>
										<p>Receive obligation free quotes from our talented freelancers fast. 80% of projects get bid on within 60 seconds.</p>
							...
							<div class="col-xl-3 col-md-6">
								<div class="great-blk aos" data-aos="fade-up">
									<div class="great-icon">
										<img src="{{URL::asset('/assets/img/icon/great-icon-04.svg')}}"  alt="Img">
									</div>
									<div class="great-content">
						...
						<div class="container">
							<div class="row justify-content-center">
								<div class="col-md-6 d-flex">
									<div class="about-it-blk w-100 aos" data-aos="fade-up">
										<div class="about-it-img">
											<a href="javascript:void(0);"><img class="img-fluid" src="{{URL::asset('/assets/img/about-it-01.jpg')}}" alt="Img"></a>
										</div>
								...
								<div class="col-md-6 d-flex">
									<div class="about-it-blk w-100 aos" data-aos="fade-up">
										<div class="about-it-img">
											<a href="javascript:void(0);"><img class="img-fluid" src="{{URL::asset('/assets/img/about-it-02.jpg')}}" alt="Img"></a>
										</div>
										<div class="about-it-content text-center">
											...
											<div class="more-project text-center mt-0">
												<a href="{{url('developer-details')}}" class="btn btn-primary start-bid">Start Bidding</a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-xl-3 col-md-4">
								<div class="job-locate-blk aos" data-aos="fade-up">
									<div class="location-img">
										<a href="{{url('project')}}"><img class="img-fluid" src="{{URL::asset('/assets/img/location/location-01.jpg')}}" alt="Img"></a>
									</div>
							...
							<div class="col-xl-3 col-md-4">
								<div class="job-locate-blk aos" data-aos="fade-up">
									<div class="location-img">
										<a href="{{url('project')}}"><img class="img-fluid" src="{{URL::asset('/assets/img/location/location-02.jpg')}}" alt="Img"></a>
									</div>
									<div class="job-it-content">
										<h6>London, UK</h6>
										<ul class="nav job-locate-foot">
							...
							<div class="col-xl-3 col-md-4">
								<div class="job-locate-blk aos" data-aos="fade-up">
									<div class="location-img">
										<a href="{{url('project')}}"><img class="img-fluid" src="{{URL::asset('/assets/img/location/location-03.jpg')}}" alt="Img"></a>
									</div>
									<div class="job-it-content">
							...
							<div class="col-xl-3 col-md-4">
								<div class="job-locate-blk aos" data-aos="fade-up">
									<div class="location-img">
										<a href="{{url('project')}}"><img class="img-fluid" src="{{URL::asset('/assets/img/location/location-04.jpg')}}" alt="Img"></a>
									</div>
									<div class="job-it-content">
										<h6>Newyork, USA</h6>
										<ul class="nav job-locate-foot">
							...
							<div class="col-xl-3 col-md-4">
								<div class="job-locate-blk aos" data-aos="fade-up">
									<div class="location-img">
										<a href="{{url('project')}}"><img class="img-fluid" src="{{URL::asset('/assets/img/location/location-05.jpg')}}" alt="Img"></a>
									</div>
									<div class="job-it-content">
										<h6>Paris, France</h6>
										<ul class="nav job-locate-foot">
							...
							<div class="col-xl-3 col-md-4">
								<div class="job-locate-blk aos" data-aos="fade-up">
									<div class="location-img">
										<a href="{{url('project')}}"><img class="img-fluid" src="{{URL::asset('/assets/img/location/location-06.jpg')}}" alt="Img"></a>
									</div>
									<div class="job-it-content">
							...
							<div class="col-xl-3 col-md-4">
								<div class="job-locate-blk aos" data-aos="fade-up">
									<div class="location-img">
										<a href="{{url('project')}}"><img class="img-fluid" src="{{URL::asset('/assets/img/location/location-07.jpg')}}" alt="Img"></a>
									</div>
									<div class="job-it-content">
							...
							<div class="col-xl-3 col-md-4">
								<div class="job-locate-blk aos" data-aos="fade-up">
									<div class="location-img">
										<a href="{{url('project')}}"><img class="img-fluid" src="{{URL::asset('/assets/img/location/location-08.jpg')}}" alt="Img"></a>
									</div>
									<div class="job-it-content">
							...
							<div class="col-xl-12">
								<div class="more-project text-center aos aos-init aos-animate" data-aos="fade-up">
									<a href="{{url('project')}}" class="btn btn-primary">View More Locations</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container">
						...
						<div class="row aos" data-aos="fade-up">
							<div class="col-lg-4 col-md-6">
								<div class="grid-blog blog-two aos" data-aos="fade-up">
									...
									<div class="blog-content">
										...
										<h3 class="blog-title mt-0"><a href="{{url('blog-details')}}">Top 10 Resume Tips for Landing Your Dream Job</a></h3>
										<p>Customize your resume for each job application. Highlight skills and experiences that align...</p>
										<div class="blog-read">
											<a href="{{url('blog-details')}}">Read More <i class="fas fa-arrow-right ms-1"></i></a>
										</div>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-md-6">
								<div class="grid-blog blog-two aos" data-aos="fade-up">
									...
									<div class="blog-content">
										...
										<h3 class="blog-title mt-0"><a href="{{url('blog-details')}}">Navigating the Gig Economy: Freelancing and Side Hustles</a></h3>
							...
							<div class="col-lg-4 col-md-6">
								<div class="grid-blog blog-two aos" data-aos="fade-up">
									<div class="blog-image">
										<a href="{{url('blog-details')}}"><img class="img-fluid" src="{{URL::asset('/assets/img/blog/blog-14.jpg')}}" alt="Post Image"></a>
									</div>
									<div class="blog-content">
										<div class="feature-time-blk">
											<span class="badge bg-pink d-flex align-items-center"><i class="feather-tag me-1"></i>Jobs</span>
										...
										<h3 class="blog-title mt-0"><a href="{{url('blog-details')}}">Interview Success: How to Ace Common Interview Questions</a></h3>
						...
						<div class="row">
							<div class="col-12">
								<div class="register-job-blk justify-content-center">
									...
									<div class="bg-img">
										<img src="{{URL::asset('/assets/img/bg/job-sec-bg-01.png')}}" class="img-fluid job-right-bg" alt="Img">
