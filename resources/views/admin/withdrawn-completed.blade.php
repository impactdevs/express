                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="table-avatar user-profile">
                                                    <a href="{{ url('admin/profile') }}"><img class="avatar-img rounded-circle "
                                            ...
                                            <td>
                                                <a href="javascript:void(0);" class="user-active-btn" data-bs-toggle="modal"
