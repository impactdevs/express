				...
				<div class="content container-fluid">
					...
					<div class="profile-cover">
						<div class="profile-cover-wrap">
							<img class="profile-cover-img" src="{{ URL::asset('/assets_admin/img/profiles/avatar-07.jpg')}}" alt="Profile Cover">
					...
					<div class="text-center mb-5">
						<label class="avatar avatar-xxl profile-cover-avatar" for="avatar_upload">
							<img class="avatar-img" src="{{ URL::asset('/assets_admin/img/profiles/avatar-07.jpg')}}" alt="Profile Image">
								...
								<div class="card-body pt-0">
									<div class="card-header mb-4">
										<h5 class="card-title d-flex justify-content-between">
											<span>Profile</span> 
											<a class="btn btn-sm btn-white" href="{{url('admin/settings')}}">Edit</a>
										</h5>
									</div>
								...
								<div class="card-body pt-0">
									...
									<ul class="activity-feed">
										<li class="feed-item">
											...
											<span class="feed-text"><a href="{{url('admin/profile')}}">Brian Johnson</a> has paid the invoice <a href="{{url('admin/view-invoice')}}">"#CD41544"</a></span>
										</li>
										<li class="feed-item">
											<div class="feed-date">Nov 7</div>
											<span class="feed-text"><a href="{{url('admin/profile')}}">Marie Canales</a>  has accepted your estimate <a href="{{url('admin/view-estimate')}}">#GTR14544</a></span>
										</li>
										<li class="feed-item">
											<div class="feed-date">Jan 05</div>
											<span class="feed-text"><a href="{{url('admin/profile')}}">Brian Johnson</a> has paid the invoice <a href="{{url('admin/view-invoice')}}">"#CD42565"</a></span>
										</li>
										<li class="feed-item">
											<div class="feed-date">Feb 10</div>
											<span class="feed-text"><a href="{{url('admin/profile')}}">Marie Canales</a>  has accepted your estimate <a href="{{url('admin/view-estimate')}}">#GTR422385</a></span>
										</li>
										<li class="feed-item">
											<div class="feed-date">Mar 25</div>
											<span class="feed-text"><a href="{{url('admin/profile')}}">Brian Johnson</a> has paid the invoice <a href="{{url('admin/view-invoice')}}">"#CD6988"</a></span>
										</li>
										<li class="feed-item">
											<div class="feed-date">Mar 5</div>
											<span class="feed-text"><a href="{{url('admin/profile')}}">Marie Canales</a>  has accepted your estimate <a href="{{url('admin/view-estimate')}}">#GTR569231</a></span>
										</li>
									</ul>
								</div>
							</div>
