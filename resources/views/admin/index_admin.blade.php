								...
								<div class="col-md-4 d-flex">
									<div class="card wizard-card flex-fill">
										<div class="card-body">
											...
											<h5>1682</h5>
											<p><a href="{{url('admin/users')}}">view details</a></p>
								...
								<div class="col-md-4 d-flex">
									<div class="card wizard-card flex-fill">
										<div class="card-body">
											...
											<h5>15k</h5>
											<p><a href="{{url('admin/projects')}}">view details</a></p>
												...
												<table class="table table-hover table-center mb-0 datatable">
													...
													<tbody>
														<tr>
															...
															<td>
																<h2 class="table-avatar">
																	<a href="{{url('admin/profile')}}"><img class="avatar-img rounded-circle me-2" src="{{ URL::asset('/assets_admin/img/profiles/avatar-14.jpg')}}" alt="User Image">
																	Janet Paden
																	</a>
																</h2>
															</td>
														...
														<tr>
															...
															<td>
																<h2 class="table-avatar">
																	<a href="{{url('admin/profile')}}"><img class="avatar-img rounded-circle me-2" src="{{ URL::asset('/assets_admin/img/profiles/avatar-01.jpg')}}" alt="User Image">
																		George Wells
																	</a>
																</h2>
															</td>
														...
														<tr>
															...
															<td>
																<h2 class="table-avatar">
																	<a href="{{url('admin/profile')}}"><img class="avatar-img rounded-circle me-2" src="{{ URL::asset('/assets_admin/img/profiles/avatar-15.jpg')}}" alt="User Image">
																		Timothy Smith
																	</a>
																</h2>
															</td>
														...
														<tr>
															...
															<td>
																<h2 class="table-avatar">
																	<a href="{{url('admin/profile')}}"><img class="avatar-img rounded-circle me-2" src="{{ URL::asset('/assets_admin/img/profiles/avatar-16.jpg')}}" alt="User Image">
																		Lois Alexander
																	</a>
																</h2>
															</td>
														...
														<tr>
															...
															<td>
																<h2 class="table-avatar">
																	<a href="{{url('admin/profile')}}"><img class="avatar-img rounded-circle me-2" src="{{ URL::asset('/assets_admin/img/profiles/avatar-03.jpg')}}" alt="User Image">
																		Sara Grayson
																	</a>
																</h2>
															</td>
														...
														<tr>
															...
															<td>
																<h2 class="table-avatar">
																	<a href="{{url('admin/profile')}}"><img class="avatar-img rounded-circle me-2" src="{{ URL::asset('/assets_admin/img/profiles/avatar-04.jpg')}}" alt="User Image">
																		Deboarah
																	</a>
																</h2>
															</td>
														...
														<tr>
															...
															<td>
																<h2 class="table-avatar">
																	<a href="{{url('admin/profile')}}"><img class="avatar-img rounded-circle me-2" src="{{ URL::asset('/assets_admin/img/profiles/avatar-11.jpg')}}" alt="User Image">
																		Sofia Briant
																	</a>
																</h2>
															</td>
														...
														<tr>
															...
															<td>
																<h2 class="table-avatar">
																	<a href="{{url('admin/profile')}}"><img class="avatar-img rounded-circle me-2" src="{{ URL::asset('/assets_admin/img/profiles/avatar-02.jpg')}}" alt="User Image">
																		Bess Twishes
																	</a>
																</h2>
															</td>
														...
														<tr>
															...
															<td>
																<h2 class="table-avatar">
																	<a href="{{url('admin/profile')}}"><img class="avatar-img rounded-circle me-2" src="{{ URL::asset('/assets_admin/img/profiles/avatar-05.jpg')}}" alt="User Image">
																		Rayan Lester
																	</a>
																</h2>
															</td>
														...
														<tr>
															...
															<td>
																<h2 class="table-avatar">
																	<a href="{{url('admin/profile')}}"><img class="avatar-img rounded-circle me-2" src="{{ URL::asset('/assets_admin/img/profiles/avatar-06.jpg')}}" alt="User Image">
																		Sarah Alexander
																	</a>
																</h2>
															</td>
												...
												<table class="table table-bordered table-hover datatable">
													...
													<tbody>
														...
														<tr>
															...
															<td>
																<h2 class="table-avatar">
																	<a href="{{url('admin/profile')}}"><img class="avatar-img rounded-circle me-2" src="{{ URL::asset('/assets_admin/img/profiles/avatar-10.jpg')}}" alt="User Image">
																		Gary Green
																	</a>
																</h2>
															</td>
